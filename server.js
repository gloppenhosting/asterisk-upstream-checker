...
domain.run(function() {
    ...
    var create_table_contacts_internal = "CREATE VIEW " + view_contacts_internal + " AS SELECT ps_contacts.* FROM ps_contacts INNER JOIN iaxfriends ON ps_contacts.regserver = iaxfriends.ipaddr WHERE iaxfriends.hostname = '" + os.hostname() + "'";
